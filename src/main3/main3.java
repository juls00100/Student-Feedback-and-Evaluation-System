...
public class main3 {
    ...
    public static void createDatabaseTables(config2 con) {
        ...
        String[] tableCreationSql = new String[] {
            ...
            "e_average_rating REAL NOT NULL," +
            "e_year TEXT NOT NULL," +
            "e_sem TEXT NOT NULL," +
            "e_remarks TEXT," +
            "s_schoolID TEXT NOT NULL," +
    ...
    private static void viewAllUsersExceptSuperAdmin(config2 con) {
    ...
    public static void main(String[] args) {
        ...
        // **CRITICAL FIX:** Call the new method to ensure tables exist before attempting any queries.
    ...
    public static void userRegistrationFlow(Scanner sc, config2 con) {
    ...
    public static void superAdminDashboard(Scanner sc, config2 con, int adminId) {
        int choice;
        do {
            System.out.println("\n===== SUPER ADMIN DASHBOARD =====");
            System.out.println("1. Manage User Approvals and Deletions"); 
    ...
    public static void adminDashboard(Scanner sc, config2 con, int adminId) {
        int choice;
        do {
            System.out.println("\n===== ADMIN DASHBOARD =====");
            System.out.println("1. Manage User Approvals"); 
            System.out.println("2. Manage Students"); 
            System.out.println("3. Manage Instructors"); 
            System.out.println("4. Manage Evaluations"); 
            System.out.println("5. Logout");
    ...
    public static void manageUserApprovals(Scanner sc, config2 con, boolean isSuperAdmin) {
        int choice;
        do {
    ...
    private static void deleteUser(config2 con, int userIdToDelete, boolean isSuperAdmin) {
    ...
    private static void instructorMainActions(Scanner sc, config2 db, int instructorID) {
        int choice;
        do {
            System.out.println("\n--- INSTRUCTOR MENU ---");
    ...
    private static void instructorMenu(Scanner sc, config2 db) {
    }
    ...
    public static String studentFlow(Scanner sc, config2 db) {
    ...
    private static void studentMenu (Scanner sc, config2 db, String studentSchoolID){
        int choyens;
    do {
        System.out.println("\n--- STUDENT MENU ---");
    ...
    private static void studentEvaluation(Scanner sc, config2 db, String studentSchoolID){
    ...
    private static void viewEvaluation(Scanner sc, config2 db, String studentSchoolID) { 
    ...
    private static void editEvaluation(Scanner sc, config2 db, String studentSchoolID) {
    ...
    private static void deleteEvaluation(Scanner sc, config2 db, String studentSchoolID) {
    ...
    private static void viewMyAcc(Scanner sc, config2 db, String studentSchoolID) {
    ...
    private static void viewMyEvaluations(Scanner sc, config2 db, int instructorID) {
        System.out.println("\n--- MY EVALUATIONS ---"); 
    ...
    private static void manageInstructors(Scanner sc, config2 db) {
        int choice;
        do {
            System.out.println("\n--- MANAGE INSTRUCTORS ---");
    ...
    private static void manageStudents(Scanner sc, config2 db) {
        int choice;
        do {
            System.out.println("\n--- MANAGE STUDENTS ---");
    ...
    private static void manageEvaluations(Scanner sc, config2 db) {
        int choice;
        do {
            System.out.println("\n--- MANAGE EVALUATIONS ---");
